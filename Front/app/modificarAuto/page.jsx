...
const Modificar = () => {
    ...
    const handleNumSerieChange = (e) => {
        ...
        // Buscar el auto correspondiente al número de serie seleccionado
        const selectedAuto = autos.find((auto) => auto.numSerie === numSerie);

        // Actualizar el estado del formulario con los datos del auto
        setFormData({
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            console.log('esoesta del put:', response);
        } catch (error) {
